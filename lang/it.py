"""
Italian translations for PDF Duplicate Finder.
This module contains all Italian translation strings organized in nested dictionaries.
"""
...
IT = {
    ...
    "settings_dialog": {
        ...
        "auto_save": "Salvataggio automatico impostazioni",
        "pdf": "Rendering PDF",
        "backend": "Backend:",
        "backend_auto": "Auto (consigliato)",
        "browse": "Sfoglia",
        "select_poppler": "Seleziona la cartella bin di Poppler",
        "poppler_path": "Percorso Poppler:",
        "select_gs": "Seleziona l'eseguibile Ghostscript",
        "ghostscript_path": "Percorso Ghostscript:",
        "saved": "Impostazioni salvate",
        "saved_message": "Le impostazioni sono state salvate.",
        "restart_required": "Riavvio necessario",
        "restart_message": "L'applicazione deve essere riavviata affinché le modifiche della lingua abbiano effetto.\nVuoi riavviare ora?",
        "language_changed": "Lingua cambiata con successo",
        "language_change_failed": "Impossibile cambiare lingua",
        "backend_ok": "OK",
        "backend_missing": "Mancante o percorso non valido",
        "no_backends_tested": "Nessun backend testato",
        "test_results_title": "Risultati test backend",
        "backend_status": "Stato backend:",
        "test_backends": "Testa backend"
    },
    "file": {
        "open": "&Apri cartella...",
    ...
    "about": {
        ...
        "system_info_html": "<html><body><h3>Informazioni sul sistema</h3><table><tr><td><b>Sistema operativo:</b></td><td>{os_info}</td></tr><tr><td><b>Versione Python:</b></td><td>{python_version}</td></tr><tr><td><b>Versione Qt:</b></td><td>{qt_version}</td></tr><tr><td><b>Versione PyQt:</b></td><td>{pyqt_version}</td></tr><tr><td><b>Risoluzione dello schermo:</b></td><td>{resolution}</td></tr><tr><td><b>Memoria:</b></td><td>{memory_info}</td></tr></table></body></html>"
    },
    "help": {
        "window_title": "Aiuto",
        ...
        "docs": {
            "window_title": "Documentazione",
            "error": {
                "directory_not_found": "Directory della documentazione non trovata",
                "initialization_failed": "Inizializzazione della documentazione fallita",
                "initialization_failed_message": "Impossibile inizializzare la documentazione. Controllare i log per i dettagli.",
                "loading_failed": "Impossibile caricare la documentazione"
            },
            "init_success": "Documentazione caricata con successo",
            "language": "Lingua:",
            "close": "Chiudi"
        }
    },
    ...
    "docs": {
        "window_title": "Documentazione",
        "error": {
            "directory_not_found": "Directory della documentazione non trovata. Reinstallare l'applicazione.",
            "initialization_failed": "Impossibile inizializzare la documentazione.",
            "initialization_failed_message": "Impossibile inizializzare la documentazione. Controllare i log per i dettagli.",
            "loading_failed": "Impossibile caricare la documentazione"
        },
        "init_success": "Documentazione caricata con successo",
    ...
    "main_window": {
        ...
        "scan_results": "Risultati Analisi",
        "scan_summary": "Riepilogo Analisi",
        "files_scanned": "File analizzati: {}",
        "duplicate_groups": "Gruppi di duplicati trovati: {}",
        "total_duplicates": "Totale file duplicati: {}",
        "space_savings": "Spazio potenzialmente risparmiabile: {}",
        "avg_similarity": "Somiglianza media: {}",
        "file_types": "Tipi di File",
        "comparison_methods": "Metodi di Confronto",
        "group": "Gruppo",
        "type": "Tipo",
        "method": "Metodo",
        "similarity": "Somiglianza",
        "notes": "Note",
        "duplicate_content": "file duplicati (contenuto identico)",
        "duplicate_images": "file simili (confronto immagini)",
        "duplicate_text": "documenti di testo simili",
        "duplicate_files": "file simili",
        "method_content_hash": "hash del contenuto",
        "method_image_hash": "hash dell'immagine",
        "method_direct": "confronto diretto",
        "files": "file",
        "no_duplicates_found": "Nessun duplicato trovato.",
        "comparing_group": "Confronto gruppo {current}/{total}...",
        "group_processed": "Gruppo {current}/{total} elaborato: trovati {found} duplicati",
    ...
    "pdf_utils": {
        ...
        "backend_trying": "Prova backend: {backend}",
        "backend_failed": "Backend non riuscito: {backend}",
        "backend_fallback_used": "Backend selezionato non riuscito, utilizzo fallback: {backend}",
        "backend_used": "Utilizzo backend: {backend}",
    ...
    "scanner": {
        "status": {
            ...
            "using_backend": "In uso backend: {}",
            "finding_duplicates": "Ricerca di duplicati...",
            "comparing_files": "Confronto file... ({current}/{total})",
            "analyzing_content": "Analisi del contenuto...",
            "comparing_images": "Confronto immagini...",
            "comparing_text": "Confronto contenuto testuale...",
    ...
    "search_dup": {
        ...
        "group": {
            ...
            "exact_match": "Contenuto identico",
            "similar_images": "Immagini simili",
            "similar_text": "Contenuto testuale simile",
            "similarity": "{percent}% simili",
            "comparison_method": "Metodo: {method}",
            "file_type": "Tipo: {file_type}",
            "size": "Dimensione: {size}",
            "modified": "Modificato: {date}",
            "path": "Percorso: {path}",
            "show_details": "Mostra dettagli confronto",
            "hide_details": "Nascondi dettagli confronto",
    ...
    "menu": {
        ...
        "help": "Aiuto",
        "open_folder": "Apri cartella",
        "open_folder_tt": "Apri una cartella per cercare PDF duplicati",
        "pdf_viewer": "Visualizzatore PDF",
        "pdf_viewer_tt": "Apri il visualizzatore PDF",
        "export_csv": "Esporta risultati in CSV",
        "export_csv_tt": "Esporta i risultati dell'ultima scansione in un file CSV",
        "exit": "Esci",
        "exit_tt": "Esci dall'applicazione",
        "select_all": "Seleziona tutto",
        "select_all_tt": "Seleziona tutti gli elementi",
        "deselect_all": "Deseleziona tutto",
        "deselect_all_tt": "Deseleziona tutti gli elementi",
        "delete_selected": "Elimina selezionati",
        "delete_selected_tt": "Sposta i file selezionati nel Cestino",
        "show_toolbar": "Mostra barra degli strumenti",
        "show_toolbar_tt": "Mostra o nascondi la barra degli strumenti",
        "show_statusbar": "Mostra barra di stato",
        "show_statusbar_tt": "Mostra o nascondi la barra di stato",
        "settings": "Impostazioni",
        "settings_tt": "Configura le impostazioni dell'applicazione",
        "log_viewer": "Visualizzatore log",
        "log_viewer_tt": "Visualizza i log dell'applicazione",
        "check_updates": "Controlla aggiornamenti",
        "check_updates_tt": "Controlla se sono disponibili aggiornamenti",
        "documentation": "Documentazione",
        "documentation_tt": "Visualizza la documentazione dell'applicazione",
        "about": "Informazioni",
        "about_tt": "Mostra informazioni sull'applicazione",
        "sponsor": "Supporta",
        "sponsor_tt": "Supporta lo sviluppo di questa applicazione"
    }
}
