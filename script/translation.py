...
TRANSLATIONS = {
    "en": {
        ...
        "delete": {
            ...
            "permanent_warning": "<span style='color: red;'>Warning: Files will be permanently deleted and cannot be recovered!</span>",
            "file_in_use_title": "File in Use",
            "file_in_use": "Cannot delete file: {filename}",
            "file_in_use_details": "The file is being used by another program.\n\nProcess: {process}\nLocation: {location}",
            "retry_button": "&Retry",
            "skip_button": "&Skip",
            "file_not_found": "File does not exist: {path}",
            "confirm_deletion_message": "Are you sure you want to delete {count} file(s)?",
            "permanent_deletion_success": "Permanently deleted: {path}",
            "permission_denied": "Permission denied while deleting {filename}. {reason}",
            "unknown_process": "Unknown process",
            "file_in_use_by": "The file is being used by: {process}",
            "file_in_use_or_no_permission": "The file might be in use or you don't have permission to delete it.",
            "delete_failed": "Delete Failed",
            "recycle_bin_success": "Moved to recycle bin: {path}",
            "recycle_bin_failed": "Recycle bin operation failed for {path}: {error}",
            "recycle_bin_failed_title": "Recycle Bin Failed",
            "recycle_bin_failed_message": "Could not move to Recycle Bin: {filename}",
            "recycle_bin_failed_details": "The file could not be moved to the Recycle Bin.\nError: {error}\n\nWould you like to permanently delete the file instead?",
            "permanent_deletion_button": "Permanently Delete",
            "unknown_error": "Unexpected error deleting {path}: {error}",
            "deletion_failed": "Failed to delete {path} after {retries} attempts",
            "last_error": "Last error: {error}",
            "successful_deletions": "Successfully deleted: {count} file(s)",
            "failed_deletions": "Failed to delete: {count} file(s)",
        ...
        "file_list": {
            ...
            "group_tooltip": "<b>Group {group_num}: {file_count} duplicate files</b><br>Size: {size}",
            "group_tooltip_savings": "<br>Space savings: {savings}",
