...
TRANSLATIONS = {
    ...
    'es': {
        ...
        'help_note': 'Nota: La aplicación compara el contenido de los PDF, no solo los nombres de archivo, asegurando una detección precisa de duplicados.',
