"""
Translation data for the PDF Duplicate Finder application.
This module contains all translation strings organized by language code.
"""
...
TRANSLATIONS_EN = {
    ...
    "docs": {
        ...
        "error": {
            "directory_not_found": "Documentation directory not found. Please reinstall the application.",
            "initialization_failed": "Documentation initialization failed",
            "initialization_failed_message": "Failed to initialize documentation. Please check the logs for details.",
            "loading_failed": "Failed to load documentation"
        },
        "init_success": "Documentation loaded successfully",
        "language": "Language:",
        "close": "Close",
        "features": "Features",
        ...
        "help_content": {
            "introduction": "<h1>PDF Duplicate Finder - Documentation</h1><p>Welcome to the PDF Duplicate Finder documentation.</p>",
            "features": "<h2>Features</h2><ul><li>Find duplicate PDF files</li><li>Compare files by content or metadata</li><li>Preview PDF files</li><li>Manage duplicates efficiently</li></ul>"
        }
    },
    "common": {
        "ok": "OK",
    ...
    "settings_dialog": {
        ...
        "auto_save": "Auto-save settings",
        "pdf": "PDF Rendering",
        "backend": "Backend:",
        "backend_auto": "Auto (recommended)",
        "browse": "Browse",
        "select_poppler": "Select Poppler bin folder",
        "poppler_path": "Poppler path:",
        "select_gs": "Select Ghostscript executable",
        "ghostscript_path": "Ghostscript path:",
        "saved": "Settings Saved",
        "saved_message": "Your settings have been saved.",
        "restart_required": "Restart Required",
        "restart_message": "The application needs to be restarted for language changes to take effect.\nDo you want to restart now?",
        "language_changed": "Language changed successfully",
        "language_change_failed": "Failed to change language",
        "backend_ok": "OK",
        "backend_missing": "Missing or invalid path",
        "no_backends_tested": "No backends tested",
        "test_results_title": "Backend Test Results",
        "backend_status": "Backend status:",
        "test_backends": "Test backends"
    },
    "file": {
        "open": "&Open Folder...",
    ...
    "about": {
        ...
        "system_info_html": "<html><body><h3>System Information</h3><table><tr><td><b>Operating System:</b></td><td>{os_info}</td></tr><tr><td><b>Python Version:</b></td><td>{python_version}</td></tr><tr><td><b>Qt Version:</b></td><td>{qt_version}</td></tr><tr><td><b>PyQt Version:</b></td><td>{pyqt_version}</td></tr><tr><td><b>Screen Resolution:</b></td><td>{resolution}</td></tr><tr><td><b>Memory:</b></td><td>{memory_info}</td></tr></table></body></html>"
    },
    "help": {
        "window_title": "Help",
        ...
        "content": {
            "en": "<h1>PDF Duplicate Finder - Help</h1><h2>Getting Started</h2><p>PDF Duplicate Finder helps you find and manage duplicate PDF files on your computer.</p><h2>How to Use</h2><ol><li>Click <b>Scan Folder</b> to select a directory to scan for duplicate PDFs</li><li>Review the duplicate groups found</li><li>Use the navigation buttons to move between groups and files</li><li>Select files and use <b>Keep</b> or <b>Delete</b> to manage duplicates</li></ol><h2>Keyboard Shortcuts</h2><ul><li><b>Ctrl+O</b>: Open folder to scan</li><li><b>Ctrl+Q</b>: Quit the application</li><li><b>F1</b>: Show this help</li></ul>"
        }
    },
    "delete": {
    ...
    "main": {
        "window_title": "PDF Duplicate Finder",
        "scan_results": "Scan Results",
        "scan_summary": "Scan Summary",
        "files_scanned": "Files scanned: {}",
        "duplicate_groups": "Duplicate groups found: {}",
        "total_duplicates": "Total duplicate files: {}",
        "space_savings": "Potential space savings: {}",
        ...
        "notes": "Notes",
        "duplicate_content": "duplicate files (exact content match)",
        "duplicate_images": "similar files (image comparison)",
        "duplicate_text": "similar text documents",
        "duplicate_files": "similar files",
        "method_content_hash": "content hash",
        "method_image_hash": "image hash",
        "method_direct": "direct comparison",
        "files": "files",
        "scan_complete": "Scan complete. Found {} duplicate groups.",
        "no_duplicates_found": "No duplicates found.",
        "comparing_group": "Comparing group {current}/{total}...",
        "group_processed": "Group {current}/{total} processed: {found} duplicates found",
    ...
    "pdf_utils": {
        ...
        "backend_trying": "Trying backend: {backend}",
        "backend_failed": "Backend failed: {backend}",
        "backend_fallback_used": "Selected backend failed, using fallback: {backend}",
        "backend_used": "Using backend: {backend}",
    ...
    "scanner": {
        "status": {
            ...
            "using_backend": "Using backend: {}",
            "finding_duplicates": "Finding duplicates...",
            "comparing_files": "Comparing files... ({current}/{total})",
            "analyzing_content": "Analyzing content...",
            "comparing_images": "Comparing images...",
            "comparing_text": "Comparing text content...",
    ...
    "search_dup": {
        ...
        "group": {
            ...
            "exact_match": "Exact content match",
            "similar_images": "Similar images",
            "similar_text": "Similar text content",
            "similarity": "{percent}% similar",
            "comparison_method": "Method: {method}",
            "file_type": "Type: {file_type}",
            "size": "Size: {size}",
            "modified": "Modified: {date}",
            "path": "Path: {path}",
            "show_details": "Show comparison details",
            "hide_details": "Hide comparison details",
    ...
    "ui": {
        "pdf_backend_fallback_title": "PDF Backend Fallback Warning",
        "pdf_backend_fallback_message": "Selected PDF backend '{selected}' failed. Falling back to '{used}'.",
    ...
    "menu": {
        ...
        "help": "Help",
        "open_folder": "Open Folder",
        "open_folder_tt": "Open a folder to scan for duplicate PDFs",
        "pdf_viewer": "PDF Viewer",
        "pdf_viewer_tt": "Open PDF Viewer",
        "export_csv": "Export Results to CSV",
        "export_csv_tt": "Export last scan results to a CSV file",
        "exit": "Exit",
        "exit_tt": "Exit the application",
        "select_all": "Select All",
        "select_all_tt": "Select all items",
        "deselect_all": "Deselect All",
        "deselect_all_tt": "Deselect all items",
        "delete_selected": "Delete Selected",
        "delete_selected_tt": "Move selected files to Recycle Bin",
        "show_toolbar": "Show Toolbar",
        "show_toolbar_tt": "Show or hide the toolbar",
        "show_statusbar": "Show Status Bar",
        "show_statusbar_tt": "Show or hide the status bar",
        "settings": "Settings",
        "settings_tt": "Configure application settings",
        "log_viewer": "Log Viewer",
        "log_viewer_tt": "View application logs",
        "check_updates": "Check for Updates",
        "check_updates_tt": "Check for application updates",
        "documentation": "Documentation",
        "documentation_tt": "View application documentation",
        "about": "About",
        "about_tt": "Show information about the application",
        "sponsor": "Sponsor",
        "sponsor_tt": "Support the development of this application"
    }
}
...
# Dictionary mapping language codes to their translations
TRANSLATIONS = {
    'en': TRANSLATIONS_EN,
    'it': TRANSLATIONS_IT
}
